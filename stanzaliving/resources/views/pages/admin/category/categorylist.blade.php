                 ...
                 <div class="col-xs-3">
                  <div class="form-group" style="margin-left: -15px;">
                    <label> &nbsp;</label><Br>
                     ...
                     <a href=" {{ url('admin/category/add') }}" class="btn btn-success pull-left" style="margin:15px;display: block;float:right;margin-left:2px;
} ">Add New Category</a>
                   </div>
                 </div>
               </div>
        ...
        <div class="col-xs-12">
          ...
          @foreach($categories as $key=>$category)
                  <tr>
                    ...
                    <td>
          <a href="{{action('CategoryController@edit',['category_id'=>$category->id])}}"><i class="fa fa-edit" aria-hidden="true"></i></a>
        <!--  <a data-toggle="modal" data-target="#myModal"><i class="fa fa-trash md-trigger" ></i></a>

@{{action('AccessController@edit',[$role->id])}}
         -->
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <a href="{{action('CategoryController@destroy',['category_id'=>$category->id])}}" data-method="delete" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
          </td>
          <!--  <td>
           <a href="{{action('CategoryController@destroy',['category_id'=>$category->id])}}" data-method="delete" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
           </td> -->
